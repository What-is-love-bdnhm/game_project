...
class Sprites:
    def __init__(self):
        self.sprite_types = {
            'barrel': pygame.image.load('../spr/barrel/0.png').convert_alpha(),
            'pedestal': pygame.image.load('../spr/pedestal/0.png').convert_alpha(),
            'devil': [pygame.image.load(f'../spr/devil/{i}.png').convert_alpha() for i in range(8)]
        }
